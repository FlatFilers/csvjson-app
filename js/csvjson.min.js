...
CSVJSON.bindFileUploadToFillTextarea($file,uploadUrl,$csv);CSVJSON.bindConvert($convert);CSVJSON.bindClear($clear);CSVJSON.setInputsForSave($('input.save, textarea.save'));function err(error){CSVJSON.reportError($json,error);return false;}
...
CSVJSON.mysql2json=function(){var errorEmpty="Please upload a file or type in something.";var uploadUrl="/mysql2json/upload";var $file=$('#fileupload'),$format=$('input[type=radio][name=format]'),$mysql=$('#mysql'),$result=$('#result'),$clear=$('#clear, a.clear'),$convert=$('#convert, a.convert');CSVJSON.bindFileUploadToFillTextarea($file,uploadUrl,$mysql);CSVJSON.bindConvert($convert);CSVJSON.bindClear($clear);CSVJSON.setInputsForSave($('input.save, textarea.save'));function err(error){CSVJSON.reportError($result,error);return false;}
...
CSVJSON.json_beautifier=function(){var errorEmpty="Please upload a file or type in something.";var uploadUrl="/json_beautifier/upload",spaceMap={'tab':'\t','1':1,'2':2,'3':3,'4':4,'.':'.','..':'..'};var $file=$('#fileupload'),$json=$('#json'),$result=$('#result'),$resultNote=$('span.result-note'),$clear=$('#clear, a.clear'),$convert=$('#convert, a.convert');CSVJSON.bindFileUploadToFillTextarea($file,uploadUrl,$json);CSVJSON.bindConvert($convert);CSVJSON.bindClear($clear);$clear.click(function(e){$resultNote.empty();});CSVJSON.setInputsForSave($('input.save, textarea.save, select.save'));function err(error){CSVJSON.reportError($result,error);return false;}
...
// js/src/main.js
$(document).ready(function(){_.mixin(_.str.exports());_.extend(CSVJSON,{init:function(){$('.container').CacheInputs({key:CSVJSON.page,ignoreOnStart:!!CSVJSON.id});if(CSVJSON.id)
