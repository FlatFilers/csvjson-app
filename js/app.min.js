...
editor.getDoc().setValue(result);});APP.start({$convert:$convert,$clear:$clear,$saveElements:$('input.save, textarea.save, select.save'),upload:{$file:$file,url:uploadUrl,editor:editor}});};
