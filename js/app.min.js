...
this.set(data);this.on('change',this.saveToLocalStorage);this.maybeUpdateSessions();},saveToLocalStorage:function(){var postfix=this.id?('_'+this.id):'';if(this.hasChanged('options'))
