...
var objects={};_.each(tables,function(table,name){var keys=table.header;objects[name]=_.map(table.values,function(values){var o={};for(var k=0;k<keys.length;k++){o[keys[k]]=values[k].replace(/^{{([0-9]+)}}$/,function(m,i){return matches[i];});if(o[keys[k]]=='{{NULL}}')o[keys[k]]=null;}
