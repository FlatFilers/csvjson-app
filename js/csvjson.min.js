...
function isObject(o){return o&&typeof o=='object';}
function inlineShortArraysInResult(result,width){width||(width=80);if(typeof width!='number'||width<20){throw"Invalid width '"+width+"'. Expecting an integer equal or larger than 20."}
