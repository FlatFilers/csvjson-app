...
this.$('.input-start.form').html(this.inputRowStartTemplate(data));this.inputEditor.getDoc().setValue(data.input);this.$('.output-start.form').html(this.outputRowStartTemplate(data));this.outputEditor.getDoc().setValue(this.error||data.output);this.outputEditor.setOption('lineWrapping',!!this.error);this.renderWorkerErrors();return this;}});}.call(this));
