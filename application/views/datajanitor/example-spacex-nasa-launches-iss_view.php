...
<p class="lead"><a href="/datajanitor/clone_example/spacex" target="_blank"><i class="glyphicon glyphicon-share"></i> Load this example in Data Janitor</a></p>
<p>
...
<p>And the output. Notice we are missing flight 7. This relates to <a href="https://en.wikipedia.org/wiki/SpaceX_CRS-7" target="_blank">flight CRS-7</a>, where Falcon disintegrated 139 seconds into flight on June 28 2015. It took another year (360 days) before the next launch.</p>
