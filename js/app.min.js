...
Backbone.DataStore.hydrateDefaults();if(localStorage.DataCleanShowCodePage){delete localStorage.DataCleanShowCodePage;$('.nav-tabs a[href="#tab-code"]').tab('show');}
