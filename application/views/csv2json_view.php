...
Nine Miles from the White City, 2013, -
	...
	<div class="row">
		<div class="col-md-8">
			...
			<p>
				Embed all the functionality of CSVJSON in any web application with <a href="https://flatfile.com/get-started?utm_source=csvjson-tools&utm_medium=header&utm_campaign=q1-2022-csvjson-redesign">Flatfile</a>, and more. Auto-match columns, validate data fields, and provide an intuitive CSV import experience.
			</p>
