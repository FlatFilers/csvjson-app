...
$result.removeClass('error').val(result).change();});APP.start({$convert:$convert,downloadFilename:'csvjson.csv',downloadMimeType:'text/plain',$clear:$clear,$saveElements:$('input.save, textarea.save'),upload:{$file:$file,url:uploadUrl,$textarea:$result}});};
// js/src/sql2json.js
